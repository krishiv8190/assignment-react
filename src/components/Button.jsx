...
export default function Button({
    ...
    switch (styleName) {
        ...
        case "form-true":
            styles =
                "bg-[#1C1C1C] mt-9 w-7/12 hover:bg-[#4E4E4E] max-w-lg  text-white font-manrope font-semibold text-lg";
            break;
        case "form-false":
            styles =
                "bg-[#C9C9C9] hover:bg-[#EAEAEA] mt-9 w-7/12 max-w-lg  text-white font-manrope font-semibold cursor-not-allowed";
            break;
        default:
            styles = "bg-[#1C1C1C] hover:bg-[#4E4E4E] text-white font-manrope";
    }
